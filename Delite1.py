...
#Create & Recode By VivekXD & Indian Hacker
...
def banner():
   print("""
\033[0;96m─────────────────────────────────────────────────────────────
\033[0;91m     ___  _______ __             \033[0;93m║ \033[0;93mCODED By \033[0;96mVivekXD \033[0;96m& \033[0;96mShivani 
\033[0;96m    / _ \/ __/ (_) /____         \033[0;96m║ \033[0;96mFB \033[0;96m: \033[0;93mFacebook.com/Vivek.chandel.420
\033[0;93m   / // / _// / / __/ -_)        \033[0;91m║ \033[0;91mWHATSAPP \033[0;96m: \033[0;96mhttps://wa.me/17087220306
\033[0;91m  /____/___/_/_/\__/\__/         \033[0;96m║ \033[0;95mGithub \033[0;96m: \033[0;92mGithub.com/MRVIVEK-CODER/Delite\033[0;96m
\033[0;96m─────────────────────────────────────────────────────────────""")

   print("""
 \033[0;96m___      ___  __  ___      ___  _______  __   ___  ___  ___  ________   
\033[0;91m|"  \    /"  ||" \|"  \    /"  |/"     "||/"| /  ")|"  \/"  ||"      "\  
\033[0;96m \   \  //  / ||  |\   \  //  /(: ______)(: |/   /  \   \  / (.  ___  :) 
 \033[0;93m \\  \/. ./  |:  | \\  \/. ./  \/    |  |    __/    \\  \/  |: \   ) || 
\033[0;96m   \.    //   |.  |  \.    //   // ___)_ (// _  \    /\.  \  (| (___\ || 
 \033[0;91m   \\   /    /\  |\  \\   /   (:      "||: | \  \  /  \   \ |:       :) 
\033[0;96m     \__/    (__\_|_)  \__/     \_______)(__|  \__)|___/\___|(________/   
\033[0;96m                                                                                                               """)
...
def menu():
  ...
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;93m[•] Hello : "+nama)
  print("\033[0;96m╚══\033[0;97m[•] UID : "+id)
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;91m[ Choose Options ]")
  print("\033[0;96m║")
  print("\033[0;96m╠══\033[0;97m[1] Dump ID Public/Friend")
  print("\033[0;96m╠══\033[0;93m[2] Crack")
  print("\033[0;96m╚══\033[0;97m[0] Logout")
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  r=raw_input("\033[0;97m   [•] Input : ")
  if r=="":print("\033[0;97m   [!] Fill in the Correct").format(R,N);menu()
  elif r=="1":
    publik()
  elif r=="2":
    methode()
...
def publik():
	...
	try:
                ...
                banner()
                print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print("\033[0;96m╔══\033[0;97m[•] Type \'me\' If You Want To Get ID From Friends List")
		...
		id = []
		z=json.loads(r.text)
		print("\033[0;93m╚══\033[0;97m[•] Getting ID ...")
		print ("\033[0;96m─────────────────────────────────────────────────────────────")
		...
		ys.close()
		print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print ('\033[0;96m╔══\033[0;97m[•] Successfully Fetched ID from %s'%op['name'])
...
def methode():
  ...
  if sek=="":print("\033[0;97m   [!] Fill in the Correct").format(R,N);methode()
  elif sek=="1":
    crack()
  elif sek=="2":
    crack1()
    ...
    print("\033[0;97m   [!] Fill in the Correct").format(R,N);methode()
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  ...
  if sek=="":
    print("\033[0;97m   [!] Fill in the Correct").format(R,N);logs()
  elif sek=="1":
    log_token()
  elif sek=="2":
    gen()
...
class crack:
	...
	def __init__(self):
		...
		while True:
			f=raw_input("\033[0;96m╠══\033[0;97m[•] Select : ")
			if f=="":continue
			elif f=="m":
				try:
					while True:
